#include <iostream> //Jonathan Martinez y Daniel Cedeño
#include <cstdlib>  // Para la función rand() y srand()
#include <ctime>    // Para la función time()
#include <cmath>
#include <fstream> //para generar el archivo de salida ()
using namespace std;
...
void mostrarTurno(bool &a, Jugador jugadores[])
{
    if (a == false)
    {
        cout << "Turno del jugador " << jugadores[0].nombre << ":" << endl
             << endl;
    }
    else
    {
        cout << "Turno del jugador " << jugadores[1].nombre << ":" << endl
             << endl;
    }
}
...
Jugador *determinarGanador(Jugador jugadores[])
{
    if (jugadores[0].monedasTotales > jugadores[1].monedasTotales)
    {
        return &jugadores[0];
    }
    else if (jugadores[0].monedasTotales < jugadores[1].monedasTotales)
    {
        return &jugadores[1];
    }
    else
    {
        return nullptr; // Indicar que es un empate
    }
}

void guardarInformacionJugadoresEnArchivo(Jugador jugadores[], const Tablero &tablero)
{
    ofstream archivo("ganador.txt");
    if (archivo.is_open())
    {
        archivo << "Jugador 1:" << endl;
        archivo << "  Nombre: " << jugadores[0].nombre << endl;
        archivo << "  Monedas totales: " << jugadores[0].monedasTotales << endl;
        archivo << "  Alfombras puestas: " << (NUM_ALFOMBRAS - jugadores[0].alfombrasRestantes) << endl;
        archivo << "  Color: Amarillo" << endl;

        archivo << "Jugador 2:" << endl;
        archivo << "  Nombre: " << jugadores[1].nombre << endl;
        archivo << "  Monedas totales: " << jugadores[1].monedasTotales << endl;
        archivo << "  Alfombras puestas: " << (NUM_ALFOMBRAS - jugadores[1].alfombrasRestantes) << endl;
        archivo << "  Color: Azul" << endl;

        archivo.close();
        cout << "Información de los jugadores guardada en ganador.txt" << endl;
    }
    else
    {
    ...
    if (jugadores[0].monedasTotales > jugadores[1].monedasTotales)
    {
        archivo << "Ganador: " << jugadores[0].nombre << endl;
    }
    else if (jugadores[0].monedasTotales < jugadores[1].monedasTotales)
    {
        archivo << "Ganador: " << jugadores[1].nombre << endl;
    }
    else
    {
        archivo << "El juego terminó en empate." << endl;
    }
}
...
int main()
{
    ...
    guardarInformacionJugadoresEnArchivo(jugadores, tablero);
}